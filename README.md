...
The data that was being used for the two machine learning models can be recreated from this repository: [EquiGen Album Cover Dataset]([https://pypi.org/project/split-folders/](https://github.com/pandrum/equigen/blob/main/README.md)).
